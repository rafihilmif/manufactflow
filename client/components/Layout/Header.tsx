...
const Header = () => {
  return (
    ...
    border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="relative p-2.5 rounded-xl text-slate-600 daark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:slate-700">
            <Image
