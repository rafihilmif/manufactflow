...
const Sidebar = () => {
  return (
    <div className="w-72 flex flex-col relative z-10 border-r border-slate-200/50 ease-in-out bg-white/80 dark:bg-slate-900/80 transition duration-300 backdrop-blur-xl">
